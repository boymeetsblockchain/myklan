...
const NewCreators = () => {
  ...
  useEffect(() => {
    const fetchNewCreators = async () => {
      ...
      try {
        const response = await axios.get('https://api.myklan.africa/public/api/creators/featured', {
          headers: {
  ...
  return (
    <SafeAreaView style={tw`bg-black flex-1`}>
      <View style={tw`px-4 pt-10`}>
        <Text style={tw`text-white text-2xl font-bold mb-4`}>Featured Creators</Text>
